...
## BUG-3 — FairManifest Has No Signature Field
...
Ryan's .fair Hardening Roadmap (March 13, 2026) directly addressed BUG-3 across two phases. Both phases shipped by March 15, 2026 in upstream main.
