# BUG-8 — .fair Attribution Not Wired to Events or Transactions — RESOLVED
...
### Remaining
- BUG-9 (.fair templates not used in upload paths) remains open — template system exists but is not called from upload routes
