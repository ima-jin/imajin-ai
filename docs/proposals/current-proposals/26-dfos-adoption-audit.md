...
- Chain integrity (cryptographic verification)
- Key roles (auth/assert/controller) after #401
...
- Check-in countersignatures (#402) use chain keys
...
**Current:** Messages stored in conversations DB. No message signing.
...
- #402 — Countersignature-based attestations
- PR #412 — Resolution endpoints
- PR #413 — Chain-aware middleware
- PR #414 — Key rotation + multi-device
