...
DROP INDEX "pay"."idx_transactions_stripe_id";--> statement-breakpoint
DROP INDEX "pay"."idx_transactions_to_did";--> statement-breakpoint
DROP INDEX "pay"."idx_balance_rollups_date";--> statement-breakpoint
DROP INDEX "pay"."idx_balance_rollups_did";--> statement-breakpoint
...
CREATE INDEX "idx_balance_rollups_did" ON "pay"."balance_rollups" USING btree ("did");