...
export const attestations = authSchema.table('attestations', {
  ...
  attestationStatus: text('attestation_status').default('pending'), // 'pending' | 'bilateral' | 'declined' | 'collecting' | 'executed' | 'expired' | 'lapsed'
  ...
  // lapsing out from under it. See migrations/0109_claim_stub_expiry.sql.
