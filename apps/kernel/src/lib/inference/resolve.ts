 ...
 *   4. Write a signed inference_attestations row chaining to the recording's CID.
 *   5. Publish inference.resolved DFOS event (federated, best-effort).
 *   6. Advance session to 'resolved'.
 */
...
export async function resolveIntent(
  ...
  // 5. Write the signed attestation row.
