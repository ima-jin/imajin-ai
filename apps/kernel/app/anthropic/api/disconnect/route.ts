/**
 * POST + OPTIONS /anthropic/api/disconnect (#1720)
 *
 * Revoke the sealed Anthropic API key's delegation grant for the session
 ...
 * `kernel.vault_delegation_grants` row for `anthropic-api-key:{ownerDid}` is
...
import { revokeApiKey } from '@/src/lib/anthropic/connector';
