...
// Articles directory - moved to docs/articles at monorepo root.
// At build time, cwd may be monorepo root or apps/www. Handle both.
...
const slugMap: Record<string, string> = {
  ...
  'essay-26-part-2-i-need-help': 'i-need-help',
