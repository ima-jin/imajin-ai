        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <input
              ...
              className="w-full px-4 py-3 border border-white/10 dark:border-white/10 bg-white dark:bg-surface-elevated focus:ring-2 focus:ring-imajin-purple focus:border-transparent"
            />
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-secondary">
                Are you a creator? <Link href="/dashboard" className="text-imajin-orange:underline">Create your first course</Link>
              </p>
            </div>
          ) : (
              ...
              {filtered.map(course => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    {course.description && (
                      <p className="text-sm text-muted dark:text-secondary mb-3 line-clamp-2">
                        {course.description}
                      </p>
                    )}
                    ...
                    {course.tags?.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-3">
                        {course.tags.slice(0, 3).map(tag => (
                          <span key={tag} className="px-2 py-0.5 text-xs rounded-full bg-surface-elevated dark:bg-surface-elevated text-muted dark:text-primary">
                            {tag}
                          </span>
                        ))}
                      </div>
