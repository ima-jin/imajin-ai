...
export const SERVICES: readonly ServiceDefinition[] = [
  ...
  { name: "market",      label: "Market",      icon: "🏪", description: "Local commerce — buy and sell with trust",           devPort: 3010, prodPort: 7010, schema: "market",      tier: "imajin", visibility: "public",        category: "core" },
