          ...
          >
            ...
            {replyToMessage && (
              <button
                ...
                className='msg-bubble-reply-to my-1 px-2 py-1 rounded-lg text-xs cursor-pointer bg-black/30 rounded-bl-none rounded-br-none border-white/50 border-l-4 text-white text-left w-full'
              >
